#!/bin/bash
# =============================================================================
# entrainement medecine - Configuration de l'environnement de développement
# =============================================================================
set -e

PYTHON_VERSION="3.11"

echo "🚀 Configuration de l'environnement entrainement medecine"
echo "=================================================================="
...
setup_github() {
    ...
    if [ "camille626" != "votre-username" ]; then
        ...
        if ssh -o BatchMode=yes -T git@github.com 2>&1 | grep -iq "successfully authenticated"; then
            remote_url="git@github.com:camille626/entrainement-medecine.git"
        else
            remote_url="https://github.com/camille626/entrainement-medecine.git"
        fi
...
echo "Docker-in-Docker activé (proxy socat via /var/run/docker-host.sock)"
